    ...
    , m_favAction(nullptr)
{
    ...
    if (!forDevTools) {
        ...
        m_urlLineEdit->setPlaceholderText(tr("Input website address here and press Enter"));
...
QMenu *BrowserWindow::createHelpMenu()
{
    ...
    helpMenu->addAction(tr("&About..."), qApp, QApplication::aboutQt);
    return helpMenu;
}
